...
int main()
{
    ...
    shared_ptr<BaseGraphics> graphic1 = grfactory->createGraphics(shared_ptr<Image>(new Image()));
    shared_ptr<BaseGraphics> 
    return 0;
}
